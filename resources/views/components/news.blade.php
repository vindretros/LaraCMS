@foreach ($news as $article)
    ...
    <article class="news-header news-header--column">
        <a href="{{route('article.show', $article->id)}}" class="news-header__link news-header__banner">
        ...
        <a href="{{route('article.show', $article->id)}}" class="news-header__link news-header__wrapper">
