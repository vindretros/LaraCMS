    ...
    <div class="row">
                ...
                <div class="card-body">
                    ...
                    <form method="POST" action="{{ route('login') }}">
                        ...
                        <div class="form-group">
                            ...
                            <input id="text" class="form-control{{ $errors->has('mail') ? ' is-invalid' : '' }}" name="mail" value="{{ old('mail') }}" required autofocus>
                            @if ($errors->has('mail'))
        ...
        <div class="col-md-6">
            <div class="card-body indexRight">
                <h1>{{ __('Welcome to :Name', ['name' => config('hotel.hotel_name')]) }}</h1>
                <p>{!!  __('index.message', ['name' => config('hotel.hotel_name')]) !!} </p>
                <div class="row">
                    <div class="col-md-4">
